  ...
  describe("Initialization", () => {
    it("should create an object with a name and age if provided valid arguments", () => {
      ...
      // TODO: Add a comment describing the purpose of the following statements
        // verify that the new object has correct properties
    ...
    it("should throw an error if provided no arguments", () => {
      ...
      // if left blank gives you an error - initialization in a callback function 
      const cb = () => new Child();

      // TODO: Add a comment describing the purpose of the following statement
      // expect an error to throw - defines it
      expect(cb).toThrow();
    });
    ...
    it("should throw an error if not provided an age", () => {
      ...
      // TODO: Add a comment describing the purpose of the following statement
      // notify you that an error is happening -catch it
